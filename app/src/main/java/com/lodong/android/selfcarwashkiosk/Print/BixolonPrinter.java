package com.lodong.android.selfcarwashkiosk.Print;
...
public class BixolonPrinter implements ErrorListener, OutputCompleteListener, StatusUpdateListener, DirectIOListener, DataListener {
                ...
                try {
                    ...
                    try {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run()
                            {
                                Toast.makeText(context, "영수증을 다시 연결하고 확인을 눌러 앱을 실행해주세요.", Toast.LENGTH_SHORT).show();
                            }
                        }, 0);
                        posPrinter.close();
                        return true;
    ...
    public boolean printText(String data, int alignment, int attribute, int textSize) {
        ...
        Log.d(TAG, "printText: 프린트 텍스트 진입");
        ...
        try {
            ...
            posPrinter.setPageModePrintArea("5 , 5, 50, 80");
